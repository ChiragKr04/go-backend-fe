...
const Signup = () => {
  const { goToHome, goToLogin } = useAppNavigation()
          ...
          <div className="max-w-md space-y-6 text-center">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Start collaborating with developers worldwide using CodeHall's powerful platform.
              </p>
            </div>
          </div>
        </div>
            ...
            <Card className="w-full">
              <CardHeader className="space-y-1">
                ...
                <p className="text-center text-muted-foreground">
                  Join CodeHall to start collaborating
                </p>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <form className="space-y-4" onSubmit={handleSignup}>
                  ...
                  <Button
                    type="submit"
                    className="w-full h-11"
                    disabled={isLoading || !username || !email || !password || isSuccess}
                  >
