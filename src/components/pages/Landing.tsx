...
const Landing = () => {
	...
	const handleSignupClick = () => {
		// TODO: Navigate to signup page when it's created
						...
						<div className="flex items-center justify-between">
							...
							<div className="flex items-center gap-8">
								...
								<nav className="flex items-center gap-9">
									<a href="#" className="text-sm font-medium hover:text-primary transition-colors cursor-pointer">
										Product
									</a>
									<a href="#" className="text-sm font-medium hover:text-primary transition-colors cursor-pointer">
										Pricing
								...
								<div className="flex items-center gap-2">
									<Button variant="default" size="sm" className="h-10 px-4" onClick={handleSignupClick}>
										Sign up
									</Button>
									<Button variant="secondary" size="sm" className="h-10 px-4" onClick={goToLogin}>
										Log in
									</Button>
								</div>
							</div>
					...
					<div className="flex items-center gap-8">
						...
						<div className="flex flex-col gap-6 flex-1">
							...
							<div className="flex items-center gap-3">
								<Button size="lg" className="h-12 px-5" onClick={handleSignupClick}>
									Sign up
								</Button>
								<Button variant="secondary" size="lg" className="h-12 px-5" onClick={goToLogin}>
									Log in
								</Button>
							</div>
						</div>
					...
					<div className="container mx-auto px-32 py-8">
						<div className="space-y-4">
							...
							<div className="flex flex-wrap items-center justify-center gap-6">
								<a href="#" className="text-base text-muted-foreground hover:text-foreground transition-colors cursor-pointer">
									Product
								</a>
								<a href="#" className="text-base text-muted-foreground hover:text-foreground transition-colors cursor-pointer">
									Pricing
